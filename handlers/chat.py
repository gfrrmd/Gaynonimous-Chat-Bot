...
- Next Partner
- Stop Chat
- Relay pesan teks, stiker, voice note
"""
import logging
...
from utils.keyboards import main_keyboard, chat_keyboard, waiting_keyboard, BTN_FIND, BTN_NEXT, BTN_STOP
...
async def find_partner(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if partner_id:
        ...
        await update.message.reply_text(PARTNER_FOUND, parse_mode="Markdown", reply_markup=chat_keyboard())
        ...
        await update.message.reply_text(SEARCHING, parse_mode="Markdown", reply_markup=waiting_keyboard())
...
async def stop_chat(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if partner_id:
        ...
        await update.message.reply_text(
            CHAT_ENDED_BY_YOU, parse_mode="Markdown", reply_markup=main_keyboard()
        )
        await context.bot.send_message(
            chat_id=partner_id,
            text=PARTNER_LEFT,
        ...
        await update.message.reply_text(NOT_IN_CHAT, parse_mode="Markdown", reply_markup=main_keyboard())
...
async def next_partner(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if new_partner:
        ...
        await state.add_to_queue(user.id)
        await update.message.reply_text(NEXT_SEARCHING, parse_mode="Markdown", reply_markup=waiting_keyboard())
